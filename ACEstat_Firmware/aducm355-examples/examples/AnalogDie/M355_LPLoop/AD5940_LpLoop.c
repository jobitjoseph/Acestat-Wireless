...
/* Initislize AFE die */
  ...
  lp_cfg.LpAmpCfg.LpTiaSW = LPTIASW(12)|LPTIASW(8)|LPTIASW(4); /* Close these switches to make sure LP PA amplifire is closed loop */
  /** Note; There is no SW15 and SW14 in Channel 1. */
  AD5940_LPLoopCfgS(&lp_cfg);

  /* For ADuCM355, we have channel 1. */
  lp_cfg.LpDacCfg.LpdacSel = LPDAC1;
  lp_cfg.LpAmpCfg.LpAmpSel = LPAMP1;  
  AD5940_LPLoopCfgS(&lp_cfg);
