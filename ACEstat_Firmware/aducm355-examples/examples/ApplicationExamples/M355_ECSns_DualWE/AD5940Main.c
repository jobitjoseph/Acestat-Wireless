...
void AD5940AMPStructInit(void)
{
  ...
  //SH Sensor is connected to CH0 on EVAL-ADuCM355QSPZ
  ...
  pAmpCfg->SensorCh0.LptiaRtiaSel = LPTIARTIA_10K;      /* LPTIA gain resistor is 30kohm */
  ...
  pAmpCfg->SensorCh1.LptiaRtiaSel = LPTIARTIA_96K;      /* Tia gain resistor is 2kohm */
