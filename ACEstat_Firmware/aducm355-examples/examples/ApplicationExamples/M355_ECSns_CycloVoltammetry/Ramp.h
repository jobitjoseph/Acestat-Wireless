...
#define OPT_RAMP_MEAS 0

typedef enum {
  OPT_RAMP_MEAS_I      = 0, /* LPTIA_P-LPTIA_N (current) */
  OPT_RAMP_MEAS_VSE0   = 1, /* VSE0-1.1V */
  OPT_RAMP_MEAS_VRE0   = 2, /* VRE0-1.1V */
  OPT_RAMP_MEAS_I2     = 3, /* LPTIA_P-LPTIA_N (current) */
  NUM_OPT_RAMP_MEAS    = 4
} OPT_RAMP_MEAS_Type;
